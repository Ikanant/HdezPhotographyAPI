...
namespace HdezPhotography.Api.Migrations
{
    ...
    [Migration("20200425230936_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HdezPhotography.Api.Entities.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("HdezPhotography.Api.Entities.Course", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HdezPhotography.Api.Entities.Course", b =>
                {
                    b.HasOne("HdezPhotography.Api.Entities.Author", "Author")
                        .WithMany("Courses")
